...
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        decoder_layer = DecoderLayer(d_model=d_model,
                                     ...
                                     dropout=dropout)
        self.encoder = timm.create_model('vit_base_patch32_384', pretrained = False)
...
n_epoch = 0
model.load_state_dict(torch.load('./vit_384_pre.ckpt'))
...
for epoch in range(EPOCH):
    ...
    for batch_idx, (imgs, cptns_all) in enumerate(train_loader):
        ...
        # progress.update(1)
    torch.save(model.state_dict(), f'vit_384_{epoch+1+n_epoch}.ckpt')
    ...
    #   progress2 = tqdm(total = math.ceil(len(val_loader)))
      ...
      with open(f'sample_384_{epoch+1+n_epoch}.json', "w") as outfile:
          json.dump(dictionary, outfile)
      eval_score(f'sample_384_{epoch+1+n_epoch}.json')