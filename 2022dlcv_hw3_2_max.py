# -*- coding: utf-8 -*-
"""2022dlcv_hw3_2.ipynb 的副本 的副本

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1H_5MzUHNTvvp3IU1trwqpEzKGb1Kmdql
...
val_loader = DataLoader(hw3_2_val, batch_size=8, shuffle=False)
...
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        decoder_layer = DecoderLayer(d_model=d_model,
                                     ...
                                     dropout=dropout)
        self.encoder = timm.create_model('maxvit_base_224', pretrained = False)
...
model_epoch = 3
model.load_state_dict(torch.load(f'./vit_max{model_epoch}.ckpt'))
...
for epoch in range(EPOCH):
    ...
    for batch_idx, (imgs, cptns_all) in enumerate(train_loader):
        ...
        # progress.update(1)
    torch.save(model.state_dict(), f'./vit_max{model_epoch+epoch+1}.ckpt')
    ...
    #   progress2 = tqdm(total = math.ceil(len(val_loader)))
      ...
      for batch_idx, (imgs, cptns_all, file_names) in enumerate(val_loader):
        ...
        #   progress2.update(1)
      with open(f'sample_max{model_epoch+epoch+1}.json', "w") as outfile:
          json.dump(dictionary, outfile)
      eval_score(f'sample_max{model_epoch+epoch+1}.json')
